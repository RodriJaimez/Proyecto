...
<div id="wrapper">
		<header id="header">
			<div class="container">
				...
				<nav id="nav">
					...
					<a href="register.php" class="btn btn-primary rounded">Registrate</a>
					<div class="nav-drop">
						<ul>
							<li class="active visible-sm visible-xs"><a href="#">Inicio</a></li>
		...
		<div class="container">
			<div class="text-block">
				<div class="heading-holder">
					<h1>Tu eliges la velocidad que necesitas</h1>
				</div>
				<p class="tagline"></p>
				<span class="info">Consigue ahora lo mejor para ti</span>
			</div>
		</div>
	...
	<section class="main">
		<div class="container">
			<div id="cta">
				<a href="javascript:" class="btn btn-primary rounded">Comienza tú servicio ahora mismo</a>
			</div>
			<div class="row">
				<div class="text-box col-md-offset-1 col-md-10">
					<h2>Sobre nuestros trabajos</h2>
					<p>Les contaremos un poco sobre nuestros trabajos a lo largo de estos años</p>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="container">
				...
				<div class="pricing-tables">
					<div class="plan">
		                ...
		                <div class="price">
		                    <span class="price-main"><span class="symbol">$</span>256</span>
		                    <span class="price-additional">por mes</span>
		                </div>
		                <ul class="item-list">
		                    <li>Internet con muchas boludeces</li>
		                </ul>
		            ...
		            <div class="plan">
		                <div class="head">
		                    <h3>Mediano</h3> </div>
		                <div class="price">
		                    <span class="price-main"><span class="symbol">$</span>339</span>
		                    <span class="price-additional">por mes</span>
		                </div>
		                    <ul class="item-list">
		                       <li>Internet con muchas boludeces</li>
		                       <li>Una mona china que te hace de support</li>
		                    </ul>
		                <button type="button" class="btn btn-default rounded">purchase</button>
		            </div>
		            <div class="plan recommended">
		                <div class="head">
		                    <h3>Grande</h3> </div>
		                <div class="price">
		                    <span class="price-main"><span class="symbol">$</span>400</span>
		                    <span class="price-additional">por mes</span>
		                </div>
		                    <ul class="item-list">
		                        <li>Internet + muchas boluedeces + mona china de oro support</li>
		                        <li>Flaco tenes toda la guita</li>
		                    </ul>
		                <button type="button" class="btn btn-default rounded">purchase</button>
		            </div>
		            <div class="plan">
		                <div class="head">
		                    <h3>El pija grande</h3> </div>
		                <div class="price">
		                    <span class="price-main"><span class="symbol">$</span>760</span>
		                    <span class="price-additional">por mes</span>
		                </div>
		                <ul class="item-list">
		                    <li>Todo lo de las anteriores + el yate del comandante con 4k e inlimitado </li>
		                    <li>Sobala, el soporte tecnico vive  en tu casa </li>
		                </ul>
		                <button type="button" class="btn btn-default rounded">purchase</button>
		            </div>
				</div>
